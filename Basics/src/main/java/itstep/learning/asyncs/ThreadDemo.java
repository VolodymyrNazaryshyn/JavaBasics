...
- многопроцессное (паралельно работают несколько процессов)
- многопоточное (параллельные потоки одного процесса)
- многозадачное (использование программных сущностей "задач" - Task (C#, Python), Promise (JS), Future (Java))
...
традиционно - это объект интерфейса Runnable
